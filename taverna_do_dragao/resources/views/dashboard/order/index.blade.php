    ...
    <main class="main-dash">
        ...
        <section class="section-dash">
            <div class="manage-dash">
                <h1 class="h1-dash">Gestão de comandas</h1>
                ...
                @foreach ($orders as $order)
                    <div class="card teste" style="width: 18rem;">
                        <div class="card-body">
                            ...
                            <div class="flex">
                                <a href="{{ route('dashboard.order.viewOrder', $order->id) }}"><button type="button" class="btn btn-primary">Visualizar</button></a>
                                <button href="#" class="btn btn-secondary">Editar</button>
                            </div>
                        </div>
                    </div>
                @endforeach
